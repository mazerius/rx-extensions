...
export interface Message<T> {id: string; value: T; completeness: number; timeOut: number; timestamp: string; type: Context}

export type Context = 'next' | 'timeout' | 'violation' | undefined;

/** OPERATOR INTERFACES */
//++
export interface UnaryFunction<T, R> { (source: T, context?: Context): R; }
...
export interface NextObserver<T> {
  ...
  error?: (err: any) => void;
  complete?: () => void;
  timeOut?: (value?: T) => void;
  violation?: (value?: T) => void;
}
